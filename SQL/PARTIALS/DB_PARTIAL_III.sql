...
AS BEGIN
	BEGIN TRY
		INSERT INTO RESERVA VALUES (@id, CONVERT(DATE, @checkin, 103), CONVERT(DATE, @checkout, 103), @id_metodo_pago, @id_cliente, @id_habitación);
	END TRY
	BEGIN CATCH
		PRINT ERROR_MESSAGE();
	END CATCH;
...
AS BEGIN
	...
	IF @resultado > 1
	BEGIN
		RAISERROR('ERROR: FECHA INVALIDA', 11, 1);
...
EXEC BOOKING_02 202, '29/06/2022', '02/07/2022',2,9,5; --funcion
